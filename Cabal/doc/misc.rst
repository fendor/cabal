...
authors who need to query Cabal for details on how it would compile a package component. 
At the moment this is only supported when using the GHC compiler.
This offers a few advantages over using the Cabal API directly,
